          ...
          <div className="max-w-4xl mx-auto">
            {timeline.map((item, index) => (
              <motion.div
                ...
                className={`flex flex-col md:flex-row items-stretch md:items-center mb-12 ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                  }`}
              >
                <div
                  className={`flex-1 text-left ${index % 2 === 0 ? "md:text-right md:pr-8" : "md:text-left md:pl-8"
                    }`}
                >
